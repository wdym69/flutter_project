              ...
              children: [
                Row(
                  children: const [
                    ...
                    SizedBox(width: 20),
                    Text('Invalid input!', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20, fontFamily: 'Arial',),),
                  ],
                ),
                Row(
                  children: const [
                    SizedBox(width: 50), // Add some horizontal spacing to align the text with the first message
                    Text("Please enter valid numbers to start.", style: TextStyle(color: Colors.white, fontSize: 14, fontFamily: 'Arial',),),
                  ],
                ),
              ],
            ),
                    ...
                    children: [
                      Row(
                        children: const [
                          ...
                          SizedBox(width: 20),
                          Text('Session Completed!', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20, fontFamily: 'Arial',),),
                        ],
                      ),
                      Row(
                        children: [
                          const SizedBox(width: 50), // Add some horizontal spacing to align the text with the first message
                          Text('You logged ${_sessionCount * _timeInt} minutes.', style: TextStyle(color: Colors.white, fontSize: 14, fontFamily: 'Arial',),),
                        ],
                      ),
                    ],
                  ),
